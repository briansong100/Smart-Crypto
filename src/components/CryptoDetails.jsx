...
import { MoneyCollectOutlined, DollarCircleOutlined, FundOutlined, ExclamationCircleOutlined, 
				NumberOutlined, ThunderboltOutlined, StopOutlined, TrophyOutlined ,CheckOutlined} 
...
//3h 24h 7d 30d 3m 1y 3y 5y
	...
	const { data, isFetching: isFetching2} = useGetCryptoDetailsQuery(coinId)
		...
		<Col className='coin-detail-contianer'>
			...
			<Col className='stats-container'>
				<Col className='coin-value-statistics'>
					<Col className='coin-value-heading' >
						<Title level={3} className='coin-detail-heading'>{cryptoDetails.name} Value Statistics</Title>
						<p>An overview showing the stats of {cryptoDetails.title}.</p>
					</Col>
				...
				<Col className='other-stats-info'>
					<Col className='coin-value-heading' >
					<Title level={3} className='coin-detail-heading'>Other Statistics</Title>
			...
			<Col className='coin-desc-link'>
				<Row className='coin-desc'>
					<Title level={3} className='coin-details-heading'>Whis is {cryptoDetails.name}</Title>
